...
On Android 16 (Project Infinity / LineageOS 23.0), the Xiaomi POCO M4 Pro 5G / Redmi Note 11S 5G (`everpal` / `evergo`) encountered severe audio routing chatter, audio patch storms, and occasional audioserver restarts when connecting wired headsets and rotating the device.
...
## 🛠️ Standalone Flashable Module (`package/SpatialAudio/package/SpatialAudio.zip`)
...
### Flash via ADB:
```bash
adb push package/SpatialAudio/package/SpatialAudio.zip /sdcard/
